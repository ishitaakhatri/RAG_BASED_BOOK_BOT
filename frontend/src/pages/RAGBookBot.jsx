...
export default function RAGBookBot() {
  ...
  const [searchMode, setSearchMode] = useState("all"); // 'all', 'books', 'papers'
  ...
  const downloadChat = () => {
    ...
    yPosition += 5;
    pdf.text(`Scope: ${searchMode.toUpperCase()}`, margin, yPosition); // Updated to show Scope
    yPosition += 5;
    ...
    pdf.text(
      `Generated by RAG Bot - ${new Date().toLocaleDateString()}`,
      pageWidth / 2,
      pageHeight - 10,
      { align: "center" }
    );
  ...
  const handleQuerySubmit = async (e) => {
    ...
    const requestPayload = {
      ...
      search_mode: searchMode, // NEW: 'all', 'books', 'papers'
      top_k: 5,
      ...(useBackendDefaults
        ? {}
        : {
